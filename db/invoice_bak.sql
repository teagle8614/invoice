...
--
-- 傾印資料表的資料 `invoice_bak`
--

INSERT INTO `invoice_bak` (`id`, `code`, `number`, `period`, `expend`, `year`) VALUES
...
--
-- 使用資料表自動遞增(AUTO_INCREMENT) `invoice_bak`
--
ALTER TABLE `invoice_bak`
