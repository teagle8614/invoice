...
--
-- 資料表結構 `award_number_bak`
--

CREATE TABLE `award_number_bak` (
...
--
-- 傾印資料表的資料 `award_number_bak`
--

INSERT INTO `award_number_bak` (`id`, `year`, `period`, `number`, `type`) VALUES
(1, 2020, 3, '78451296', 1),
(2, 2020, 3, '02154876', 2),
(3, 2020, 3, '89651502', 3),
(4, 2020, 3, '65320012', 3),
